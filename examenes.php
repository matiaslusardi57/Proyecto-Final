...
$consulta="select distinct e.`Numero`,e.`Fecha_examen`,e.`Descripcion`,e.`Nota`,e.`examen_grado`,e.`Materia_Cod_materia`,  e.`idExamen`
from `examen`e 
...
where e.`examen_grado`=$pp and e.`Materia_Cod_materia`=$a";
...
<img src="img/examen.jpg" height="200" style="margin:50px 0; width: 200px; " alt="logo examen"><br>
</div>
...
<tr>
 ...
 <td class="success"><h4>Temas</h4></td>
 <td class="success"><h4>Nota</h4></td>
 <?php  
...
<tr>
 ...
 <td class="danger"> <?php  echo $fila["Fecha_examen"] . " ";?></td>
 <td class="warning">  <?php  echo $fila["Descripcion"] . " ";?></td>
 <td class="danger">
  <a href="javascript:ventanasecundaria('<?php echo $fila["idExamen"]; ?>')"><?php echo $fila["Nota"]; ?></a>
 </td>
...
<div class="col-sm-offset-3 col-lg-4" style="margin:100px 0;"><h1> <?php echo "Sin Examenes Por El Momento";?></h1></div>
