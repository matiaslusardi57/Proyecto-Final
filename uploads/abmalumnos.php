...
<div class="col-lg-6 col-lg-offset-3" style="margin-top: 20px; margin-bottom: 20px;">
    <button class="btn btn-success btn-lg btn-block" onclick="nueva()">Agregar alumno</botton>
</div>
...
?>
                                        <tr>
                                            ...
                                            <button type="button" class="btn btn-warning"  onClick="editar(<?php echo $r["DNI_Alumno"] ?>)">
                                            ...
                                            <td class="sorting_1" style="text-align: center;">
                                              <button type="button" class="btn btn-danger" onClick="borrar(<?php echo $r["DNI_Alumno"] ?>)">Borrar</button>
                                            </td>
                                        </tr>
<?php 
  }
...
<div class="col-lg-6 col-lg-offset-3" style="margin-top: 20px; margin-bottom: 20px;">
  ...
  function borrar(DNI_Alumno) {
    location.href = "alumnoborrar.php?DNI_Alumno=" + DNI_Alumno;
  }

  function editar(DNI_Alumno) {
    location.href = "alumnoeditar.php?DNI_Alumno=" + DNI_Alumno;
  }

  function nueva() {
    location.href = "alumnonuevo.php";
  }
