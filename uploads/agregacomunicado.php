...
?>
         ...
         <button type="button" class="btn btn-primary btn-lg btn-block" onClick="agregaotr(<?php echo "$grado" ?>)" style="margin:0 5px;">Agregar Otro</button>
         </div>
         </div>  
