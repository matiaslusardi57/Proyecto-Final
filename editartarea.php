...
?>
  ...
  <form class="form-horizontal" action="ediciontareaterminada.php" method="post">
  		<div class="hidden">
            <label for="id" class="col-lg-3 control-label" style="text-align: center;">Id</label>
                <div class="col-lg-8">
                  <input type="number" REQUIRED class="form-control" name="id" value="<?php echo $tarea; ?>">
                </div>
        </div>
        <div class="form-group">
            <label for="dni" class="col-lg-3 control-label" style="text-align: center;">Nro.</label>
                <div class="col-lg-8">
                  <input type="number" REQUIRED class="form-control" name="numero" value="<?php echo($fila['Numero']); ?>">
                </div>
        </div>
        <div class="form-group">
            <label for="nomyap" class="col-lg-3 control-label" style="margin-top: 7px; text-align: center;">Fecha de Entrega</label>
                <div class="col-lg-8">
                  <input type="text" REQUIRED class="form-control" name="fecha" id="datepicker" value="<?php echo($fila['Fecha_entrega_tarea']); ?>">
                </div>
        </div>
        <div class="form-group">
        ...
        <div class="hidden">
            <label for="direccion" class="col-lg-3 control-label" style="margin-top: 7px; text-align: center;">Grado</label>
                <div class="col-lg-8">
                  <input type="number" REQUIRED class="form-control" name="grado" value="<?php echo ($fila['tarea_grado']); ?>">
                </div>
        </div>
        <div class="hidden">
