                             ...
                             <table class="table table-striped table-bordered table-hover" id="dataTables-addControls">
                                    <thead>
                                        <tr>                                         
                                            ...
                                            <th style="text-align: center;">Libreta</th>                                        
                                        </tr>
                                    </thead>
                                    <tbody>
<?php 
...
?>
                                        <tr>
                                          ...
                                          <td style="text-align: center;">
                                            <button type="button" class="btn btn-success" onClick="agregalibreta(<?php echo $r["Cod_materia"].','.$r["Grado_Nro_grado"] ?>)" style="margin:0 5px;">Cargar Libretas</button>
                                          </td>
...
?>
  ...
  function agregalibreta(Cod_materia,Grado_Nro_grado) {
  location.href ="agregalibreta.php?Cod_materia=" + Cod_materia + "&Grado_Nro_grado=" + Grado_Nro_grado;
