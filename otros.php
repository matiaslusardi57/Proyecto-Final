...
$consulta="select c.`Numero`,c.`Descripcion`,c.`Fecha`,c.`Docente` 
from `comunicado`c
inner join `alumno`alu 
on c.`Grado_Nro_grado`= alu.`Grado_Nro_grado` 
...
<div class="row">
<div class="visible-lg col-lg-offset-2 col-lg-2" style="padding-left: 0px;">
<img src="img/tel.jpg" height="200"  style="margin:50px 0; width: 200px; " alt="logo comunicados"><br>
</div>
<?php  
...
<div class="col-lg-offset-3 col-lg-4" style="margin:100px 0;"><h1> <?php echo "Nada Por El Momento";?></h1></div>
