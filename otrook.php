...
<h1 style="text-align:center;">Comunicados <?php echo $grado; ?>° Grado</h1><br>
            ...
            <div class="row">
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-addControls">
                                    ...
                                    <form name="form7" method="post" action="agregacomunicado.php?Grado_Nro_grado=<?php echo $grado; ?>" autocomplete="off">
                                    <tbody>
         ...
         <button type="button" class="btn btn-primary btn-lg btn-block" onClick="agregaotr(<?php echo "$grado" ?>)">Volver</button>
