...
<head>
  <meta charset="UTF-8">
  <title>Listado Docente-Materia</title>
...
<div class="container">
    ...
    <h1>Materias</h1>
            ...
            <div class="row">
            <form name="form2" method="post" action="procesavinculom.php">
                            ...
                            while ($r = mysqli_fetch_array($rs) ) {
                              ?>
                                        <tr>
                                            ...
                                            <td><INPUT type="radio" name="padre" value="<?php  echo $r["DNI_docente"]; ?> " required> </td>
                   ...
                   $sql = "SELECT *
                    ...
                    ?>
                                        <tr>
                                            ...
                                            <td><?php  echo $r["1"]; ?></td>
                                            <td><?php  echo $r["3"]; ?></td>
                                            <td><INPUT type="radio" name="alumno" value="<?php echo $r["3"].$r["0"] ?>" required> </td>
